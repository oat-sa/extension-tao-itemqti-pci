...
class ImportExportTest extends TaoPhpUnitTestRunner
{
     ...
     * @expectedException oat\taoQtiItem\model\portableElement\exception\PortableElementNotFoundException
     */
    public function testInexistingPciImsLikert(){
        $this->portableElementService->retrieve('IMSPCI', 'imsSamplePciLikert');
    }
    ...
    public function testImportImsPci()
    {
        ...
        //check parsed likert interaction data
        $this->assertEquals('urn:fdc:taotesting.com:pci:likert', $likertData['typeIdentifier']);
        ...
        $pciLikert = $this->portableElementService->retrieve('IMSPCI', 'urn:fdc:taotesting.com:pci:likert');
    ...
    public function testRemovePci(){
        ...
        $pciImsLikert = $this->portableElementService->retrieve('IMSPCI', 'urn:fdc:taotesting.com:pci:likert');
