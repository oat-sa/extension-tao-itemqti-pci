 ...
 *
 */
define(['qtiCustomInteractionContext', 'jquery_2_1_1', 'likertInteractionSample/runtime/js/renderer'], function(qtiCustomInteractionContext, $, renderer){
    'use strict';

    var _typeIdentifier = 'likertInteractionSample';
