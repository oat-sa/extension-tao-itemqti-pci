...
define([
    ...
    function renderLabels(id, $container, config, assetManager){
        ...
        $labelMin.append($('<img>', {src: assetManager.resolve('oatSamplePciLikert/runtime/assets/ThumbDown.png')}).css({top: 6, marginLeft:12}));
        $labelMax.prepend($('<img>', {src: assetManager.resolve('oatSamplePciLikert/runtime/assets/ThumbUp.png')}).css({top: 2, marginRight:12}));
