...
define(['jquery_2_1_1'], function($){
    ...
    function renderLabels(id, $container, config, assetManager){
        ...
        if(assetManager){
            $labelMin.append($('<img>', {src: assetManager.resolve('imsSamplePciLikert/runtime/assets/ThumbDown.png')}).css({top: 6, marginLeft:12}));
            $labelMax.prepend($('<img>', {src: assetManager.resolve('imsSamplePciLikert/runtime/assets/ThumbUp.png')}).css({top: 2, marginRight:12}));
        }else{
