        ...
        return {
            ...
            initConfig: function initConfig(config) {
                ...
                this.config = {
                    ...
                    toolsStatus: {
                        frac: toBoolean(config.tool_frac, false),
                        sqrt: toBoolean(config.tool_sqrt, false),
                        exp: toBoolean(config.tool_exp, false),
                        log: toBoolean(config.tool_log, false),
                        ln: toBoolean(config.tool_ln, false),
                        limit: toBoolean(config.tool_limit, false),
                        sum: toBoolean(config.tool_sum, false),
                        nthroot: toBoolean(config.tool_nthroot, false),
                        e: toBoolean(config.tool_e, false),
                        infinity: toBoolean(config.tool_infinity, false),
                        lbrack: toBoolean(config.tool_lbrack, false),
                        rbrack: toBoolean(config.tool_rbrack, false),
                        pi: toBoolean(config.tool_pi, false),
                        cos: toBoolean(config.tool_cos, false),
                        sin: toBoolean(config.tool_sin, false),
                        tan: toBoolean(config.tool_tan, false),
                        lte: toBoolean(config.tool_lte, false),
                        gte: toBoolean(config.tool_gte, false),
                        times: toBoolean(config.tool_times, false),
                        divide: toBoolean(config.tool_divide, false),
                        plusminus: toBoolean(config.tool_plusminus, false),
                        angle: toBoolean(config.tool_angle, false),
                        minus: toBoolean(config.tool_minus, false),
                        plus: toBoolean(config.tool_plus, false),
                        equal: toBoolean(config.tool_equal, false),
                        lower: toBoolean(config.tool_lower, false),
                        greater: toBoolean(config.tool_greater, false),
                        subscript: toBoolean(config.tool_subscript, false),
                        lbrace: toBoolean(config.tool_lbrace, false),
                        rbrace: toBoolean(config.tool_rbrace, false),
                        lparen: toBoolean(config.tool_lparen, false),
                        rparen: toBoolean(config.tool_rparen, false),
                        integral: toBoolean(config.tool_integral, false),
                        timesdot: toBoolean(config.tool_timesdot, false),
                        triangle: toBoolean(config.tool_triangle, false),
                        similar: toBoolean(config.tool_similar, false),
                        paral: toBoolean(config.tool_paral, false),
                        perp: toBoolean(config.tool_perp, false),
                        inmem: toBoolean(config.tool_inmem, false),
                        ninmem: toBoolean(config.tool_ninmem, false),
                        union: toBoolean(config.tool_union, false),
                        intersec: toBoolean(config.tool_intersec, false),
                        colon: toBoolean(config.tool_colon, false),
                        to: toBoolean(config.tool_to, false),
                        congruent: toBoolean(config.tool_congruent, false),
                        subset: toBoolean(config.tool_subset, false),
                        superset: toBoolean(config.tool_superset, false),
                        contains: toBoolean(config.tool_contains, false),
                        approx: toBoolean(config.tool_approx, false),
                        vline: toBoolean(config.tool_vline, false),
                        degree: toBoolean(config.tool_degree, false),
                        percent: toBoolean(config.tool_percent, false),
                        matrix_2row: toBoolean(config.tool_matrix_2row, false),
                        matrix_2row_2col: toBoolean(config.tool_matrix_2row_2col, false),
                    },
