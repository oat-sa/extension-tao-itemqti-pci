<div class="math-entry-response-wrap">
    <div class="math-entry-correct-wrap" data-index="0">
        <span class="math-entry-response-title math-entry-response-correct">{{__ "Correct"}}</span>
    </div>
    <div class="math-entry-score-wrap math-entry-response-correct">
        ...
        <input value type="text" data-for="0" name="mathEntryScoreInput"
