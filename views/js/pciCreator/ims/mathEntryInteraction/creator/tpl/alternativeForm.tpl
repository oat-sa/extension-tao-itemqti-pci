<div class="math-entry-response-wrap">
    ...
    <div class="math-entry-score-wrap math-entry-response-alternative">
        ...
        <input value="{{score}}" type="number" data-for="{{index}}" name="mathEntryScoreInput" class="math-entry-score-input math-entry-response-alternative" data-validate="$numeric" data-validate-option="$allowEmpty; $event(type=keyup)" placeholder="{{placeholder}}">
    </div>
</div>
