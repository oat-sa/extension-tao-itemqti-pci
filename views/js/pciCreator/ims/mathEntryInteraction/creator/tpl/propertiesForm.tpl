...
<div class="tools">
    <div>
        <label class="panel">
            <input name="toggle_all" type="checkbox"/>
            <span class="icon-checkbox"></span>
            {{__ "Enable all symbols"}}
        </label>
    </div>
    <hr />
    ...
    <div class="group">
        <div class="group-title">
            <label class="panel">
                ...
                <span class="icon-checkbox"></span>
                <h3><strong>{{__ "Functions"}}</strong></h3>
            </label>
        </div>
    ...
    <div class="group">
        <div class="group-title">
            <label class="panel">
                <input name="group" type="checkbox"/>
                <span class="icon-checkbox"></span>
                <h3><strong>{{__ "Symbols"}}</strong></h3>
            </label>
        </div>
        <div>
            <label class="panel">
    ...
    <div class="group">
        <div class="group-title">
            <label class="panel">
                <input name="group" type="checkbox"/>
                <span class="icon-checkbox"></span>
                <h3><strong>{{__ "Geometry"}}</strong></h3>
            </label>
        </div>
        <div>
            <label class="panel">
    ...
    <div class="group">
        <div class="group-title">
            <label class="panel">
                <input name="group" type="checkbox"/>
                <span class="icon-checkbox"></span>
                <h3><strong>{{__ "Trigonometry"}}</strong></h3>
            </label>
        </div>
        <div>
            <label class="panel">
    ...
    <div class="group">
        <div class="group-title">
            <label class="panel">
                <input name="group" type="checkbox"/>
                <span class="icon-checkbox"></span>
                <h3><strong>{{__ "Comparison"}}</strong></h3>
            </label>
        </div>
        <div>
            <label class="panel">
    ...
    <div class="group">
        <div class="group-title">
            <label class="panel">
                <input name="group" type="checkbox"/>
                <span class="icon-checkbox"></span>
                <h3><strong>{{__ "Operands"}}</strong></h3>
            </label>
        </div>
        <div>
            <label class="panel">
