...
buffer+='/>\r\n        <span class="icon-checkbox"></span>\r\n        '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"lower than or equal symbol",options):helperMissing.call(depth0,"__","lower than or equal symbol",options)))+" "+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"lower than or equal",options):helperMissing.call(depth0,"__","lower than or equal",options)))+'\r\n    </label>\r\n</div>\r\n<div>\r\n    <label class="panel">\r\n        <input name="tool_gte" type="checkbox" ',
stack1=helpers.if.call(depth0,depth0&&depth0.tool_gte,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+='/>\r\n        <span class="icon-checkbox"></span>\r\n        '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"greater than or equal symbol",options):helperMissing.call(depth0,"__","greater than or equal symbol",options)))+" "+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
...
useGapExpression:toBoolean(interaction.prop("useGapExpression"),!1),focusOnDenominator:toBoolean(interaction.prop("focusOnDenominator"),!1),tool_frac:toBoolean(interaction.prop("tool_frac"),!0),tool_sqrt:toBoolean(interaction.prop("tool_sqrt"),!0),tool_exp:toBoolean(interaction.prop("tool_exp"),!0),tool_log:toBoolean(interaction.prop("tool_log"),!0),tool_ln:toBoolean(interaction.prop("tool_ln"),!0),tool_e:toBoolean(interaction.prop("tool_e"),!0),tool_infinity:toBoolean(interaction.prop("tool_infinity"),!0),squarebkts:toBoolean(interaction.prop("tool_rbrack"),!0)&&toBoolean(interaction.prop("tool_lbrack"),!0),tool_pi:toBoolean(interaction.prop("tool_pi"),!0),
tool_cos:toBoolean(interaction.prop("tool_cos"),!0),tool_sin:toBoolean(interaction.prop("tool_sin"),!0),tool_lte:toBoolean(interaction.prop("tool_lte"),!0),tool_gte:toBoolean(interaction.prop("tool_gte"),!0),tool_times:toBoolean(interaction.prop("tool_times"),!0),tool_divide:toBoolean(interaction.prop("tool_divide"),!0),tool_plusminus:toBoolean(interaction.prop("tool_plusminus"),!0),roundbkts:toBoolean(interaction.prop("tool_rparen"),!0)&&toBoolean(interaction.prop("tool_lparen"),!0),curlybkts:toBoolean(interaction.prop("tool_rbrace"),!0)&&toBoolean(interaction.prop("tool_lbrace"),!0),tool_angle:toBoolean(interaction.prop("tool_angle"),!0),
tool_minus:toBoolean(interaction.prop("tool_minus"),!0),tool_plus:toBoolean(interaction.prop("tool_plus"),!0),tool_equal:toBoolean(interaction.prop("tool_equal"),!0),tool_lower:toBoolean(interaction.prop("tool_lower"),!0),tool_greater:toBoolean(interaction.prop("tool_greater"),!0),tool_subscript:toBoolean(interaction.prop("tool_subscript"),!0),tool_integral:toBoolean(interaction.prop("tool_integral"),!0),tool_timesdot:toBoolean(interaction.prop("tool_timesdot"),!0),tool_triangle:toBoolean(interaction.prop("tool_triangle"),!0),tool_similar:toBoolean(interaction.prop("tool_similar"),!0),tool_paral:toBoolean(interaction.prop("tool_paral"),!0),
tool_perp:toBoolean(interaction.prop("tool_perp"),!0),tool_inmem:toBoolean(interaction.prop("tool_inmem"),!0),tool_ninmem:toBoolean(interaction.prop("tool_ninmem"),!0),tool_union:toBoolean(interaction.prop("tool_union"),!0),tool_intersec:toBoolean(interaction.prop("tool_intersec"),!0),allowNewLine:toBoolean(interaction.prop("allowNewLine"),!1),enableAutoWrap:toBoolean(interaction.prop("enableAutoWrap"),!1)})),formElement.initWidget($form),formElement.setChangeCallbacks($form,interaction,{identifier:function(i,value){response.id(value),interaction.attr("responseIdentifier",value)},useGapExpression:function(i,value){toBoolean(value,!1)?(self.createAddGapBtn(),
$gapStyleBox.show(),response.cardinality="multiple"):(i.prop("gapExpression",""),self.removeAddGapBtn(),$gapStyleBox.hide(),response.cardinality="single"),response.attr("cardinality","single"),configChangeCallBack(i,value,"useGapExpression")},gapStyle:function(i,newStyle){i.prop("gapStyle",newStyle),configChangeCallBack(i,newStyle,"gapStyle")},authorizeWhiteSpace:configChangeCallBack,focusOnDenominator:configChangeCallBack,tool_frac:configChangeCallBack,tool_sqrt:configChangeCallBack,tool_exp:configChangeCallBack,tool_log:configChangeCallBack,tool_ln:configChangeCallBack,tool_e:configChangeCallBack,tool_infinity:configChangeCallBack,
tool_pi:configChangeCallBack,tool_cos:configChangeCallBack,tool_sin:configChangeCallBack,tool_lte:configChangeCallBack,tool_gte:configChangeCallBack,tool_times:configChangeCallBack,tool_divide:configChangeCallBack,tool_plusminus:configChangeCallBack,tool_angle:configChangeCallBack,tool_minus:configChangeCallBack,tool_plus:configChangeCallBack,tool_equal:configChangeCallBack,tool_lower:configChangeCallBack,tool_greater:configChangeCallBack,tool_subscript:configChangeCallBack,tool_integral:configChangeCallBack,tool_timesdot:configChangeCallBack,tool_triangle:configChangeCallBack,tool_similar:configChangeCallBack,tool_paral:configChangeCallBack,
tool_perp:configChangeCallBack,tool_inmem:configChangeCallBack,tool_ninmem:configChangeCallBack,tool_union:configChangeCallBack,tool_intersec:configChangeCallBack,squarebkts:function(i,value){i.prop("tool_lbrack",value),i.prop("tool_rbrack",value),i.triggerPci("configChange",[i.getProperties()])},roundbkts:function(i,value){i.prop("tool_lparen",value),i.prop("tool_rparen",value),i.triggerPci("configChange",[i.getProperties()])},curlybkts:function(i,value){i.prop("tool_lbrace",value),i.prop("tool_rbrace",value),i.triggerPci("configChange",[i.getProperties()])},allowNewLine:configChangeCallBack,enableAutoWrap:configChangeCallBack}),
$gapStyleBox=$form.find(".mathgap-style-box"),$gapStyleSelector=$gapStyleBox.find("[data-mathgap-style]"),$gapStyleSelector.select2({width:"100%",minimumResultsForSearch:1/0}).val(interaction.prop("gapStyle")).trigger("change")},MathEntryInteractionStateQuestion.prototype.addMathFieldListener=function(){var _widget=this.widget,interaction=_widget.element;interaction.onPci("responseChange",function(latex){toBoolean(interaction.prop("useGapExpression"),!1)?interaction.prop("gapExpression",latex):interaction.prop("gapExpression","")})},MathEntryInteractionStateQuestion.prototype.createAddGapBtn=function(){
var _widget=this.widget,$container=_widget.$container,$toolbar=$container.find(".toolbar"),interaction=_widget.element;$toolbar.length&&($toolbar.after($addGapBtn),$addGapBtn.on("click",function(){interaction.getResponseDeclaration().removeMapEntries(),interaction.triggerPci("addGap")}))},MathEntryInteractionStateQuestion.prototype.removeAddGapBtn=function(){$addGapBtn.off("click"),$addGapBtn.remove()},MathEntryInteractionStateQuestion}),define("mathEntryInteraction/creator/widget/states/Correct",["taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/states/Correct"],function(stateFactory,Correct){"use strict"
;return stateFactory.create(Correct,function(){this.widget.element.getResponseDeclaration().setTemplate("MAP_RESPONSE"),this.widget.changeState("map")},function(){})}),define("tpl!mathEntryInteraction/creator/tpl/answerForm",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){function program1(depth0,data){var stack1,helper,options,buffer="";return buffer+='\r\n                <div class="correct-answer-entry" data-correct-answer="'+escapeExpression(typeof depth0===functionType?depth0.apply(depth0):depth0)+'">\r\n                    <p>'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},
data:data},helper?helper.call(depth0,"Correct answer option",options):helperMissing.call(depth0,"__","Correct answer option",options)))+" "+escapeExpression((helper=helpers.increaseIndex||depth0&&depth0.increaseIndex,options={hash:{},data:data},helper?helper.call(depth0,null==data||!1===data?data:data.index,options):helperMissing.call(depth0,"increaseIndex",null==data||!1===data?data:data.index,options)))+'</p>\r\n                    <a href="#" class="answer-edit" id="edit_'+escapeExpression((stack1=null==data||!1===data?data:data.index,
typeof stack1===functionType?stack1.apply(depth0):stack1))+'">\r\n                        <span class="icon-edit"></span>\r\n                        <span>'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"edit the answer",options):helperMissing.call(depth0,"__","edit the answer",options)))+'</span>\r\n                    </a>\r\n\r\n                    <br>\r\n\r\n                    <a href="#" class="answer-delete" id="delete_'+escapeExpression((stack1=null==data||!1===data?data:data.index,
...
;var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing,self=this;return buffer+='<div class="panel mathEntryInteraction">\r\n    <hr>\r\n    <h3>Define correct responses: </h3>\r\n    <div class="answer-entries-config" data-config-for-hot-uid="'+escapeExpression((stack1=null==data||!1===data?data:data.key,typeof stack1===functionType?stack1.apply(depth0):stack1))+'">\r\n        <div class="panel">\r\n            <div class="entry-config">\r\n                ',stack1=helpers.each.call(depth0,depth0&&depth0.correctAnswerEntries,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),
data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\r\n            </div>\r\n        </div>\r\n\r\n    </div>\r\n\r\n</div>"})}),define("tpl!mathEntryInteraction/creator/tpl/addAnswerOption",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,options,buffer="",helperMissing=helpers.helperMissing;return buffer+='<button class="add-answer-option" style="background-color: #3e7da7">\r\n    <i class="adder"> </i> '+(0,this.escapeExpression)((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
helper?helper.call(depth0,"Add an answer option",options):helperMissing.call(depth0,"__","Add an answer option",options)))+"\r\n</button>"})}),define("mathEntryInteraction/creator/widget/states/Map",["handlebars","i18n","lodash","jquery","taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/states/Map","taoQtiItem/qtiCreator/widgets/helpers/formElement","tpl!mathEntryInteraction/creator/tpl/answerForm","tpl!mathEntryInteraction/creator/tpl/addAnswerOption"],function(hb,__,_,$,stateFactory,Map,formElement,answerFormTpl,addAnswerOptionBtn){"use strict";hb.registerHelper("increaseIndex",function(value,options){return parseInt(value)+1})
;var MathEntryInteractionStateResponse=stateFactory.create(Map,function(){this.initGlobalVariables(),this.initForm()},function(){this.emptyGapFields(),this.toggleResponseMode(!1),this.saveAnswers(),this.removeResponseChangeEventListener(),this.removeEditDeleteListeners(),this.removeAddButtonListener(),this.destroyForm()});return MathEntryInteractionStateResponse.prototype.initGlobalVariables=function(){var self=this,interaction=self.widget.element;self.activeEditId=null,self.correctResponses=[],!0===this.inGapMode(self)&&(interaction=self.widget.element,self.gapTemplate=interaction.prop("gapExpression"))},
MathEntryInteractionStateResponse.prototype.initForm=function(){var self=this,$responseForm=(self.widget.element,self.widget.$responseForm);this.initResponseChangeEventListener(),self.correctResponses=this.getExistingCorrectAnswerOptions(),$responseForm.html(addAnswerOptionBtn()),this.initAddAnswerButton(),this.renderForm(self.correctResponses)},MathEntryInteractionStateResponse.prototype.initAddAnswerButton=function(){var self=this,interaction=self.widget.element;self.widget.$responseForm.find($(".add-answer-option")).on("click",function(){var newCorrectAnswer;if(!0===self.inGapMode()){self.emptyGapFields()
...
MathEntryInteractionStateResponse.prototype.initResponseChangeEventListener=function(){var self=this,interaction=self.widget.element;interaction.onPci("responseChange",function(latex){if(self.inGapMode(self)||null==self.activeEditId){if(self.inGapMode(self)&&null!=self.activeEditId){var response=interaction.getResponse();self.correctResponses[self.activeEditId]=response.base.string}}else self.correctResponses[self.activeEditId]=latex})},MathEntryInteractionStateResponse.prototype.removeResponseChangeEventListener=function(){this.widget.element.offPci("responseChange")},MathEntryInteractionStateResponse.prototype.initEditingOptions=function(){
var self=this,interaction=self.widget.element;self.widget.$responseForm.find(".entry-config").find(".answer-edit").click(function(e){e.preventDefault(),e.stopImmediatePropagation(),self.toggleResponseMode(!0);var selectedEditId=parseInt(e.currentTarget.id.split("_")[1],10);if(self.activeEditId!==selectedEditId)if(!0===self.inGapMode()){self.activeEditId=selectedEditId;var response=self.getGapResponseObject(self.correctResponses[self.activeEditId]);interaction.triggerPci("latexGapInpfut",[response])}else self.activeEditId=parseInt(e.currentTarget.id.split("_")[1]),
interaction.triggerPci("latexInput",[self.correctResponses[self.activeEditId]]);else self.emptyGapFields()})},MathEntryInteractionStateResponse.prototype.getGapResponseObject=function(response){return{list:{string:response.split(",")}}},MathEntryInteractionStateResponse.prototype.clearMapEntries=function(){var self=this,interaction=self.widget.element,response=interaction.getResponseDeclaration(),mapEntries=response.getMapEntries();_.keys(mapEntries).forEach(function(mapKey){response.removeMapEntry(mapKey,!0)})},MathEntryInteractionStateResponse.prototype.initDeletingOptions=function(){var self=this,interaction=self.widget.element
;self.widget.$responseForm.find(".entry-config").find(".answer-delete").click(function(e){e.preventDefault(),e.stopImmediatePropagation();var id=parseInt(e.currentTarget.id.split("_")[1]);!0===self.inGapMode()?(self.activeEditId=id,self.emptyGapFields()):(self.activeEditId=null,interaction.triggerPci("latexInput",[""])),self.correctResponses.splice(id,1),self.renderForm(self.correctResponses)})},MathEntryInteractionStateResponse.prototype.renderForm=function(correctAnswerOptions){var self=this,$responseForm=self.widget.$responseForm;this.removeEditDeleteListeners(),$responseForm.find(".mathEntryInteraction").remove(),$responseForm.append(answerFormTpl({
correctAnswerEntries:correctAnswerOptions})),this.initDeletingOptions(),this.initEditingOptions()},MathEntryInteractionStateResponse.prototype.removeEditDeleteListeners=function(){var self=this,$entryConfig=self.widget.$responseForm.find(".entry-config");$entryConfig.find(".answer-edit").off("click"),$entryConfig.find(".answer-delete").off("click")},MathEntryInteractionStateResponse.prototype.removeAddButtonListener=function(){this.widget.$responseForm.find($(".add-answer-option")).off("click")},MathEntryInteractionStateResponse.prototype.destroyForm=function(){this.widget.$responseForm.find(".mathEntryInteraction").remove()},
MathEntryInteractionStateResponse.prototype.saveAnswers=function(){var self=this,interaction=self.widget.element,responseDeclaration=interaction.getResponseDeclaration();this.clearMapEntries(),!0===this.inGapMode()&&(self.correctResponses=self.correctResponses.filter(function(response){return-1===response.split(",").indexOf("")})),self.correctResponses.forEach(function(response){responseDeclaration.setMapEntry(response,1,!1)})},MathEntryInteractionStateResponse.prototype.emptyGapFields=function(){var self=this,interaction=self.widget.element;!0===this.inGapMode()&&(self.activeEditId=null,interaction.prop("gapExpression",self.gapTemplate),
this.toggleResponseMode(!1))},MathEntryInteractionStateResponse.prototype.toggleResponseMode=function(value){var self=this,interaction=self.widget.element;interaction.prop("inResponseState")!==value&&(interaction.prop("inResponseState",value),interaction.triggerPci("configChange",[interaction.getProperties()]))},MathEntryInteractionStateResponse.prototype.inGapMode=function(){return this.widget.element.prop("useGapExpression")},MathEntryInteractionStateResponse}),
