...
interaction.triggerPci("latexInput",[self.correctResponses[self.activeEditId]]);else self.emptyGapFields()})},MathEntryInteractionStateResponse.prototype.getGapResponseObject=function(response){return{list:{string:response.split(",")}}},MathEntryInteractionStateResponse.prototype.clearMapEntries=function(){var self=this,interaction=self.widget.element,response=interaction.getResponseDeclaration(),mapEntries=response.getMapEntries();_.keys(mapEntries).forEach(function(mapKey){response.removeMapEntry(mapKey,!0)})},MathEntryInteractionStateResponse.prototype.initDeletingOptions=function(){var self=this
;self.widget.$responseForm.find(".entry-config").find(".answer-delete").click(function(e){e.preventDefault(),e.stopImmediatePropagation();var id=parseInt(e.currentTarget.id.split("_")[1]);!0===self.inGapMode()&&(self.activeEditId=id,self.emptyGapFields()),self.activeEditId=null,self.correctResponses.splice(id,1),self.renderForm(self.correctResponses)})},MathEntryInteractionStateResponse.prototype.renderForm=function(correctAnswerOptions){var self=this,$responseForm=self.widget.$responseForm;this.removeEditDeleteListeners(),$responseForm.find(".mathEntryInteraction").remove(),$responseForm.append(answerFormTpl({correctAnswerEntries:correctAnswerOptions})),
this.initDeletingOptions(),this.initEditingOptions()},MathEntryInteractionStateResponse.prototype.removeEditDeleteListeners=function(){var self=this,$entryConfig=self.widget.$responseForm.find(".entry-config");$entryConfig.find(".answer-edit").off("click"),$entryConfig.find(".answer-delete").off("click")},MathEntryInteractionStateResponse.prototype.removeAddButtonListener=function(){this.widget.$responseForm.find($(".add-answer-option")).off("click")},MathEntryInteractionStateResponse.prototype.destroyForm=function(){this.widget.$responseForm.find(".mathEntryInteraction").remove()},MathEntryInteractionStateResponse.prototype.saveAnswers=function(){
var self=this,interaction=self.widget.element,responseDeclaration=interaction.getResponseDeclaration();this.clearMapEntries(),!0===this.inGapMode()&&(self.correctResponses=self.correctResponses.filter(function(response){return-1===response.split(",").indexOf("")})),self.correctResponses.forEach(function(response){responseDeclaration.setMapEntry(response,1,!1)})},MathEntryInteractionStateResponse.prototype.emptyGapFields=function(){var self=this,interaction=self.widget.element;!0===this.inGapMode()&&(self.activeEditId=null,interaction.prop("gapExpression",self.gapTemplate),this.toggleResponseMode(!1))},
MathEntryInteractionStateResponse.prototype.toggleResponseMode=function(value){var self=this,interaction=self.widget.element;interaction.prop("inResponseState")!==value&&(interaction.prop("inResponseState",value),interaction.triggerPci("configChange",[interaction.getProperties()]))},MathEntryInteractionStateResponse.prototype.inGapMode=function(){return this.widget.element.prop("useGapExpression")},MathEntryInteractionStateResponse}),
