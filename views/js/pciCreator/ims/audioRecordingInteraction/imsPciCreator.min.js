...
useMediaStimulus:typeCaster.strToBool(interaction.prop("useMediaStimulus"),!1),updateResponsePartially:typeCaster.strToBool(interaction.prop("updateResponsePartially"),!0),partialUpdateInterval:parseInt(interaction.prop("partialUpdateInterval"),10)/1e3,displayDownloadLink:typeCaster.strToBool(interaction.prop("displayDownloadLink"),!1)}))),$mediaStimulusForm=$form.find(".media-stimulus-properties-form"),$mediaStimulusForm.append(pciMediaManager.getForm()),$compressedOptions=$form.find('[data-role="compressedOptions"]'),$uncompressedOptions=$form.find('[data-role="uncompressedOptions"]'),$delayOptions=$form.find('[data-role="delayOptions"]'),
...
$compressedOptions.show()):($uncompressedOptions.show(),$compressedOptions.hide()),configChangeCallBack(boundInteraction,value,name)},audioBitrate:configChangeCallBack,isStereo:configChangeCallBack,useMediaStimulus:function(boundInteraction,value,name){value?($mediaStimulusForm.removeClass("hidden"),$mediaStimulusForm.show(250)):$mediaStimulusForm.hide(250),configChangeCallBack(boundInteraction,value,name)},partialUpdateInterval:function(boundInteraction,value,name){value=1e3*parseFloat(value),configChangeCallBack(boundInteraction,value,name)},displayDownloadLink:configChangeCallBack},pciMediaManager.getChangeCallbacks())),pciMediaManager.init()},
...
define(["audioRecordingInteraction/imsPciCreator"],function(IMSPCI){return IMSPCI});
