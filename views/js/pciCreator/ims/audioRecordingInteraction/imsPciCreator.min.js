define("tpl!audioRecordingInteraction/creator/tpl/propertiesForm",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){function program1(depth0,data){return'checked="checked"'}function program3(depth0,data){return'style="display:none"'}function program5(depth0,data){return' selected="selected"'}this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",helperMissing=helpers.helperMissing,escapeExpression=this.escapeExpression,self=this
...
helper?helper.call(depth0,"Recording starts automatically once test taker give microphone use authorisation.",options):helperMissing.call(depth0,"__","Recording starts automatically once test taker give microphone use authorisation.",options)))+'\n    </span>\n</div>\n\n<div data-role="delayOptions" ',stack1=helpers.unless.call(depth0,depth0&&depth0.autoStart,{hash:{},inverse:self.noop,fn:self.program(3,program3,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+='>\n    <div class="panel">\n        <label for="delay-minutes" class="spinner">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
helper?helper.call(depth0,"Min:",options):helperMissing.call(depth0,"__","Min:",options)))+'</label>\n        <input id="delay-minutes" name="delayMinutes" value="',(helper=helpers.delayMinutes)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.delayMinutes,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'" data-increment="1" data-min="0" data-max="20" type="text" />\n        <label for="delay-seconds" class="spinner">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
helper?helper.call(depth0,"Sec:",options):helperMissing.call(depth0,"__","Sec:",options)))+'</label>\n        <input id="delay-seconds" name="delaySeconds" value="',(helper=helpers.delaySeconds)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.delaySeconds,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'" data-increment="15" data-min="0" data-max="45" type="text" />\n    </div>\n</div>\n\n<div class="panel">\n    <label>\n        <input name="autoPlayback" type="checkbox" ',stack1=helpers.if.call(depth0,depth0&&depth0.autoPlayback,{hash:{},inverse:self.noop,
fn:self.program(1,program1,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+='/>\n        <span class="icon-checkbox"></span> '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Auto playback recording",options):helperMissing.call(depth0,"__","Auto playback recording",options)))+'\n    </label>\n    <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\n    <span class="tooltip-content">\n        '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
...
helper?helper.call(depth0,"Mono",options):helperMissing.call(depth0,"__","Mono",options)))+'</option>\n            <option value="true"',stack1=helpers.if.call(depth0,depth0&&depth0.isStereo,{hash:{},inverse:self.noop,fn:self.program(5,program5,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+=">"+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
helper?helper.call(depth0,"Stereo",options):helperMissing.call(depth0,"__","Stereo",options)))+'</option>\n        </select>\n    </div>\n</div>\n\n<hr />\n\n<h3 class="txt-error"><strong><span class="icon-warning"></span> '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"For tests only",options):helperMissing.call(depth0,"__","For tests only",options)))+'</strong></h3>\n\n<div class="panel">\n    <label>\n        <input name="displayDownloadLink" type="checkbox" ',stack1=helpers.if.call(depth0,depth0&&depth0.displayDownloadLink,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data
...
define("audioRecordingInteraction/creator/widget/states/Question",["lodash","i18n","jquery","module","taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/interactions/states/Question","taoQtiItem/qtiCreator/widgets/helpers/formElement","taoQtiItem/qtiCreator/widgets/helpers/pciMediaManager/pciMediaManager","taoQtiItem/qtiCreator/editor/simpleContentEditableElement","tpl!audioRecordingInteraction/creator/tpl/propertiesForm","util/typeCaster"],function(_,__,$,module,stateFactory,Question,formElement,pciMediaManagerFactory,simpleEditor,formTpl,typeCaster){"use strict";function configChangeCallBack(interaction,value,name){
interaction.prop(name,value),interaction.triggerPci("configChange",[interaction.getProperties()])}var AudioRecordingInteractionStateQuestion=stateFactory.extend(Question,function(){},function(){var $container=this.widget.$container;simpleEditor.destroy($container)});return AudioRecordingInteractionStateQuestion.prototype.initForm=function(){var $compressedOptions,$uncompressedOptions,$delayOptions,_widget=this.widget,$form=_widget.$form,interaction=_widget.element,response=interaction.getResponseDeclaration(),pciMediaManager=pciMediaManagerFactory(_widget);$form.html(formTpl(_.defaults({},module.config(),{serial:response.serial,
identifier:interaction.attr("responseIdentifier"),allowPlayback:typeCaster.strToBool(interaction.prop("allowPlayback"),!0),autoStart:typeCaster.strToBool(interaction.prop("autoStart"),!1),autoPlayback:typeCaster.strToBool(interaction.prop("autoPlayback"),!1),delayMinutes:interaction.prop("delayMinutes"),delaySeconds:interaction.prop("delaySeconds"),maxRecords:interaction.prop("maxRecords"),maxRecordingTime:interaction.prop("maxRecordingTime"),isCompressed:typeCaster.strToBool(interaction.prop("isCompressed"),!0),audioBitrate:interaction.prop("audioBitrate"),isStereo:typeCaster.strToBool(interaction.prop("isStereo"),!1),
updateResponsePartially:typeCaster.strToBool(interaction.prop("updateResponsePartially"),!0),partialUpdateInterval:parseInt(interaction.prop("partialUpdateInterval"),10)/1e3,displayDownloadLink:typeCaster.strToBool(interaction.prop("displayDownloadLink"),!1)}))),$compressedOptions=$form.find('[data-role="compressedOptions"]'),$uncompressedOptions=$form.find('[data-role="uncompressedOptions"]'),$delayOptions=$form.find('[data-role="delayOptions"]'),formElement.initWidget($form),formElement.setChangeCallbacks($form,interaction,_.assign({identifier:function(i,value){response.id(value),interaction.attr("responseIdentifier",value)},
...
partialUpdateInterval:function(boundInteraction,value,name){value=1e3*parseFloat(value),configChangeCallBack(boundInteraction,value,name)},displayDownloadLink:configChangeCallBack},pciMediaManager.getChangeCallbacks())),pciMediaManager.init()},AudioRecordingInteractionStateQuestion}),define("audioRecordingInteraction/creator/widget/states/states",["taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/interactions/customInteraction/states/states","audioRecordingInteraction/creator/widget/states/Question"],function(factory,states){"use strict";return factory.createBundle(states,arguments,["answer","correct","map"])}),
define("css!audioRecordingInteraction/creator/css/audioRecordingInteraction",[],function(){}),define("audioRecordingInteraction/creator/widget/Widget",["taoQtiItem/qtiCreator/widgets/interactions/customInteraction/Widget","audioRecordingInteraction/creator/widget/states/states","css!audioRecordingInteraction/creator/css/audioRecordingInteraction"],function(Widget,states){"use strict";var AudioRecordingInteractionWidget=Widget.clone();return AudioRecordingInteractionWidget.initCreator=function(){var $interaction;this.registerStates(states),Widget.initCreator.call(this),$interaction=this.$container.find(".audioRecordingInteraction"),
$interaction.length&&$interaction.addClass("tao-qti-creator-context")},AudioRecordingInteractionWidget}),define("tpl!audioRecordingInteraction/creator/tpl/markup",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{},
'<div class="audioRecordingInteraction">\n    <div class="audio-rec">\n        <div class="input-meter">\n            <div class="countdown-pie-chart"> </div>\n            <div class="leds"> </div>\n            <div class="mic"> </div>\n        </div>\n        <div class="progress"> </div>\n        <div class="controls"> </div>\n    </div>\n</div>'})}),define("audioRecordingInteraction/imsPciCreator",["lodash","taoQtiItem/qtiCreator/editor/customInteractionRegistry","audioRecordingInteraction/creator/widget/Widget","tpl!audioRecordingInteraction/creator/tpl/markup"],function(_,ciRegistry,Widget,markupTpl){"use strict";var audioRecordingInteractionCreator={
getTypeIdentifier:function(){return"audioRecordingInteraction"},getWidget:function(){var defaultProperties;return Widget.beforeStateInit(function(event,pci){pci.typeIdentifier&&"audioRecordingInteraction"===pci.typeIdentifier&&(defaultProperties=audioRecordingInteractionCreator.getDefaultProperties(),_.forEach(defaultProperties,function(value,name){(void 0===pci.properties[name]||"string"==typeof pci.properties[name]&&!pci.properties[name]&&"string"!=typeof value)&&(pci.properties[name]=value)}))}),Widget},getDefaultProperties:function(){return{isReviewMode:!1,allowPlayback:!0,autoStart:!1,autoPlayback:!1,delayMinutes:0,delaySeconds:0,maxRecords:2,
maxRecordingTime:120,isCompressed:!0,audioBitrate:2e4,isStereo:!1,media:{autostart:!0,replayTimeout:5,maxPlays:2},displayDownloadLink:!1,updateResponsePartially:!0,partialUpdateInterval:1e3}},afterCreate:function(){},getMarkupTemplate:function(){return markupTpl},getMarkupData:function(pci,defaultData){return defaultData}};return audioRecordingInteractionCreator}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))
}('.item-editor-interaction-related div[data-role="delayOptions"] .panel{margin-top:-15px}.item-editor-interaction-related div[data-role="delayOptions"] .panel label[for="delayMinutes"]{min-width:0}.item-editor-interaction-related div[data-role="delayOptions"] .panel label[for="delaySeconds"]{min-width:0;padding-left:18px}\n\n/*# sourceMappingURL=audioRecordingInteraction.css.map */'),define(["audioRecordingInteraction/imsPciCreator"],function(IMSPCI){return IMSPCI});
