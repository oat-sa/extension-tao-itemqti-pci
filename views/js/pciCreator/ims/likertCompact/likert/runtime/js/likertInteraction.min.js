...
(useImportLoad?importLoad:linkLoad)(req.toUrl(cssId+".css"),load)},cssAPI}),define("css!likertCompactInteraction/likert/runtime/css/style",[],function(){}),define("likertCompactInteraction/likert/runtime/js/likertInteraction",["qtiCustomInteractionContext","taoQtiItem/portableLib/jquery_2_1_1","likertCompactInteraction/likert/runtime/js/renderer","taoQtiItem/portableLib/OAT/util/event","css!likertCompactInteraction/likert/runtime/css/style"],function(qtiCustomInteractionContext,$,renderer,event){"use strict";var _typeIdentifier="likertCompactInteraction",likertInteraction={typeIdentifier:_typeIdentifier,getInstance:function(dom,config,state){var response=config.boundTo;
this.initialize(Object.getOwnPropertyNames(response).pop(),dom,config.properties,config.assetManager),this.setSerializedState(state),"function"==typeof config.onready&&config.onready(this,this.getState())},getState:function(){return this.getSerializedState()},oncompleted:function(){this.destroy()},getResponse:function(){var $container=$(this.dom),value=parseInt($container.find("input:checked").val())||0;return{base:{integer:value}}},destroy:function(){var $container=$(this.dom);$container.off().empty()},getTypeIdentifier:function(){return _typeIdentifier},initialize:function(id,dom,config,assetManager){var self=this;event.addEventMgr(this),this.dom=dom,this.config=config||{},
renderer.render(id,this.dom,this.config,assetManager),this.on("levelchange",function(level){self.config.level=level,renderer.renderChoices(id,self.dom,self.config)})},setResponse:function(response){var $container=$(this.dom),value=response&&response.base?parseInt(response.base.integer):-1;$container.find('input[value="'+value+'"]').prop("checked",!0)},resetResponse:function(){var $container=$(this.dom);$container.find("input").prop("checked",!1)},setSerializedState:function(state){state&&state.response&&this.setResponse(state.response)},getSerializedState:function(){return{response:this.getResponse()}}};return qtiCustomInteractionContext.register(likertInteraction),
likertInteraction}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))}('/*add some style, need to scope (using the typeIdentifier as class prefix) every style declaration to prevent collision */\n.likertInteraction{\n    width:100%;\n    padding:10px 20px 16px !important;\n    margin-bottom:20px;\n    background-image: url("data:image/png;base64,");\n    background-repeat: repeat;\n}\n\n.likertInteraction ul.likert{\n    list-style-type: none;\n    margin: 0 5px;\n    padding: 0;\n    display:inline-block;\n    position: relative;\n    top:7px;\n}\n\n.likertInteraction ul.likert li{\n    float: left;\n    text-align: left;\n    list-style-type: none;\n}\n\n.likertInteraction ul.likert li input{margin: 0 3px; cursor: pointer;}\n\n.likertInteraction .prompt {position:relative;}\n\n.likertInteraction .likert-label {min-width:90px; color: #444;}\n.likertInteraction .likert-label-min {text-align: right;}\n.likertInteraction .likert-label-max {text-align: left;}\n.likertInteraction .likert-label img {position:relative; width:16px;}'),
define(["likertCompactInteraction/likert/runtime/js/likertInteraction"],function(IMSPCI){return IMSPCI});
