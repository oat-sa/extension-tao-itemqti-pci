...
define("likertInteraction/likert/creator/widget/Widget",["taoQtiItem/qtiCreator/widgets/interactions/customInteraction/Widget","likertInteraction/likert/creator/widget/states/states"],function(Widget,states){"use strict";var LikertScaleInteractionWidget=Widget.clone();return LikertScaleInteractionWidget.initCreator=function(){this.registerStates(states),Widget.initCreator.call(this),this.element.getResponseDeclaration().setTemplate("NONE")},LikertScaleInteractionWidget}),define("tpl!likertInteraction/likert/creator/tpl/markup",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],
helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="";return buffer+='<div class="likertInteraction">\n    <style>\n        .likertInteraction ul.likert{\n            list-style-type: none;\n            margin: 0 5px;\n            padding: 0;\n            display: inline-block;\n            position: relative;\n            top: 7px;\n        }\n        .likertInteraction ul.likert li{\n            float: left;\n            text-align: left;\n            list-style-type: none;\n        }\n    </style>\n    <div class="prompt">',(helper=helpers.prompt)?stack1=helper.call(depth0,{hash:{},data:data
}):(helper=depth0&&depth0.prompt,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),(stack1||0===stack1)&&(buffer+=stack1),buffer+='</div>\n    <ul class="likert"></ul>\n</div>'})}),define("likertInteraction/imsPciCreator",["lodash","likertInteraction/likert/creator/widget/Widget","tpl!likertInteraction/likert/creator/tpl/markup"],function(_,Widget,markupTpl){"use strict";return{getTypeIdentifier:function(){return"likertInteraction"},getWidget:function(){return Widget},getDefaultProperties:function(pci){return{level:5,"label-min":"min","label-max":"max"}},afterCreate:function(pci){pci.getResponseDeclaration().setTemplate("NONE")
},getMarkupTemplate:function(){return markupTpl},getMarkupData:function(pci,defaultData){return defaultData.prompt=pci.data("prompt"),defaultData}}}),define(["likertInteraction/imsPciCreator"],function(IMSPCI){return IMSPCI});
