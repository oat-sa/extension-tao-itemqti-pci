...
latex:'\\angle',fn:'cmd',desc:'Angle'},minus:{label:'–',latex:'-',fn:'write',desc:'Minus'},plus:{label:'+',latex:'+',fn:'write',desc:'Plus'},equal:{label:'=',latex:'=',fn:'write',desc:'Equal'},lower:{label:'<',latex:'<',fn:'write',desc:'Lower than'},greater:{label:'>',latex:'>',fn:'write',desc:'Greater than'},subscript:{label:'x&#8345;',latex:'_',fn:'cmd',desc:'Subscript'},lbrace:{label:'{',latex:'\\left{',fn:'cmd',desc:'Left brace/curly bracket'},rbrace:{label:'}',latex:'\\right}',fn:'cmd',desc:'Right brace/curly bracket'},lparen:{label:'(',latex:'\\left(',fn:'cmd',desc:'Left parenthese/round bracket'},rparen:{label:')',latex:'\\right)',fn:'cmd',desc:'Right parenthese/round bracket'},
integral:{label:'&#x222b;',latex:'\\int',fn:'cmd',desc:'Indefinitve integral'},timesdot:{label:'·',latex:'\\cdot',fn:'cmd',desc:'Times dot'},},availableToolGroups=[{id:'functions',tools:['sqrt','frac','exp','subscript','log','ln']},{id:'symbols',tools:['e','infinity','lparen','rparen','lbrace','rbrace','lbrack','rbrack','angle','integral']},{id:'trigo',tools:['pi','sin','cos']},{id:'comparison',tools:['lower','greater','lte','gte']},{id:'operands',tools:['equal','plus','minus','times','timesdot','divide','plusminus']}];this.$toolbar.empty(),
availableToolGroups.forEach(function(toolgroup){self.$toolbar.append(self.createToolGroup(toolgroup,availableTools))})},createToolGroup:function(group,availableTools){var self=this,$toolGroup=$("<div>",{class:"math-entry-toolgroup","data-identifier":group.id}),activeTools=0;return group.tools.forEach(function(toolId){var toolConfig=availableTools[toolId];toolConfig.id=toolId,
...
this.mathField instanceof MathQuill&&this.mathField.revert()},setSerializedState:function(state){this.setResponse(state)},getSerializedState:function(){return this.getResponse()}},qtiCustomInteractionContext.register(mathEntryInteraction)}),define(["mathEntryInteraction/runtime/mathEntryInteraction"],function(PCI){return PCI});
