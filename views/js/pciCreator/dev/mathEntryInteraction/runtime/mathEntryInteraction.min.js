...
latex:"\\sqrt",fn:"cmd",desc:"Square root"},exp:{label:"x&#8319;",latex:"^",fn:"cmd",desc:"Exponent"},log:{label:"log",latex:"\\log",fn:"cmd",desc:"Log"},ln:{label:"ln",latex:"\\ln",fn:"cmd",desc:"Ln"},e:{label:"&#8494;",latex:"\\mathrm{e}",fn:"write",desc:"Euler's constant"},infinity:{label:"&#8734;",latex:"\\infty",fn:"cmd",desc:"Infinity"},lbrack:{label:"[",latex:"\\lbrack",fn:"cmd",desc:"Left bracket"},rbrack:{label:"]",latex:"\\rbrack",fn:"cmd",desc:"Right bracket"},pi:{label:"&pi;",latex:"\\pi",fn:"cmd",desc:"Pi"},cos:{label:"cos",latex:"\\cos",fn:"cmd",desc:"Cosinus"},sin:{label:"sin",latex:"\\sin",fn:"cmd",desc:"Sinus"},lte:{label:"&le;",
latex:"\\le",fn:"cmd",desc:"Lower than or equal"},gte:{label:"&ge;",latex:"\\ge",fn:"cmd",desc:"Greater than or equal"},times:{label:"&times;",latex:"\\times",fn:"cmd",desc:"Multiply"},divide:{label:"&divide;",latex:"\\div",fn:"cmd",desc:"Divide"},plusminus:{label:"&#177;",latex:"\\pm",fn:"cmd",desc:"Plus/minus"},angle:{label:"&ang;",latex:"\\angle",fn:"cmd",desc:"Angle"},minus:{label:"–",latex:"-",fn:"write",desc:"Minus"},plus:{label:"+",latex:"+",fn:"write",desc:"Plus"},equal:{label:"=",latex:"=",fn:"write",desc:"Equal"},lower:{label:"<",latex:"<",fn:"write",desc:"Lower than"},greater:{label:">",latex:">",fn:"write",desc:"Greater than"},subscript:{
label:"_",latex:"_",fn:"cmd",desc:"Subscript"},lbrace:{label:"{",latex:"{",fn:"cmd",desc:"Left brace/curly bracket"},rbrace:{label:"}",latex:"}",fn:"cmd",desc:"Right brace/curly bracket"},lparen:{label:"(",latex:"(",fn:"write",desc:"Left parenthese/round bracket"},rparen:{label:")",latex:")",fn:"write",desc:"Right parenthese/round bracket"},integral:{label:"&#x222b;",latex:"\\int",fn:"cmd",desc:"Indefinitve integral"},timesdot:{label:"·",latex:"\\cdot",fn:"cmd",desc:"Times dot"},triangle:{label:"&#9651;",latex:"\\triangle",fn:"cmd",desc:"Triangle"},similar:{label:"&sim;",latex:"\\sim",fn:"cmd",desc:"Similar"},paral:{label:"&#8741;",latex:"\\parallel",
fn:"cmd",desc:"Is parallel with"},perp:{label:"&#8869;",latex:"\\perp",fn:"cmd",desc:"Is perpendicular to"},inmem:{label:"&isin;",latex:"\\in",fn:"cmd",desc:"Is member of"},ninmem:{label:"&notin;",latex:"\\notin",fn:"cmd",desc:"Is not member of"},union:{label:"&cup;",latex:"\\cup",fn:"cmd",desc:"Set union"},intersec:{label:"&cap;",latex:"\\cap",fn:"cmd",desc:"Set intersection"}},availableToolGroups=[{id:"functions",tools:["sqrt","frac","exp","subscript","log","ln"]},{id:"symbols",tools:["e","infinity","lparen","rparen","lbrace","rbrace","lbrack","rbrack","integral"]},{id:"geometry",tools:["angle","triangle","similar","paral","perp"]},{id:"trigo",
