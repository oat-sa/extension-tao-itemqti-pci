...
this.mathField instanceof MathQuill&&this.mathField.revert()},setSerializedState:function(state){state&&state.response&&this.setResponse(state.response)},getSerializedState:function(){return{response:this.getResponse()}}},qtiCustomInteractionContext.register(mathEntryInteraction)}),define(["mathEntryInteraction/runtime/mathEntryInteraction"],function(PCI){return PCI});
