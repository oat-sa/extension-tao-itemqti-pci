...
timesdot:toBoolean(config.tool_timesdot,!0)},allowNewLine:toBoolean(config.allowNewLine,!1),enableAutoWrap:toBoolean(config.enableAutoWrap,!1)}},getMqConfig:function(){var self=this;return{spaceBehavesLikeTab:!this.config.authorizeWhiteSpace,handlers:{edit:function(mathField){self.trigger("responseChange",[mathField.latex()]),self.autoWrapContent()},enter:function(mathField){(function(){return self.config.allowNewLine&&(!self.inGapMode()&&!self.inQtiCreator()||self.inGapMode()&&self.inQtiCreator())})()&&mathField.write("\\embed{br}")}}}},togglePlaceholder:function(displayPlaceholder){this.$inputPlaceholder||(this.$inputPlaceholder=$("<div>",{
...
label:"+",latex:"+",fn:"write",desc:"Plus"},equal:{label:"=",latex:"=",fn:"write",desc:"Equal"},lower:{label:"<",latex:"<",fn:"write",desc:"Lower than"},greater:{label:">",latex:">",fn:"write",desc:"Greater than"},subscript:{label:"x&#8345;",latex:"_",fn:"cmd",desc:"Subscript"},lbrace:{label:"{",latex:"{",fn:"cmd",desc:"Left brace/curly bracket"},rbrace:{label:"}",latex:"}",fn:"cmd",desc:"Right brace/curly bracket"},lparen:{label:"(",latex:"(",fn:"cmd",desc:"Left parenthese/round bracket"},rparen:{label:")",latex:")",fn:"cmd",desc:"Right parenthese/round bracket"},integral:{label:"&#x222b;",latex:"\\int",fn:"cmd",desc:"Indefinitve integral"},timesdot:{
label:"·",latex:"\\cdot",fn:"cmd",desc:"Times dot"}},availableToolGroups=[{id:"functions",tools:["sqrt","frac","exp","subscript","log","ln"]},{id:"symbols",tools:["e","infinity","lparen","rparen","lbrace","rbrace","lbrack","rbrack","angle","integral"]},{id:"trigo",tools:["pi","sin","cos"]},{id:"comparison",tools:["lower","greater","lte","gte"]},{id:"operands",tools:["equal","plus","minus","times","timesdot","divide","plusminus"]}];this.$toolbar.empty(),availableToolGroups.forEach(function(toolgroup){self.$toolbar.append(self.createToolGroup(toolgroup,availableTools))})},createToolGroup:function(group,availableTools){var self=this,$toolGroup=$("<div>",{
...
;this.inGapMode()?gapFields.forEach(function(gapField){gapField.latex("")}):this.setLatex("")},destroy:function(){this.$input.find(".mq-editable-field").off(ns),this.$input.off(ns),this.$toolbar.off(ns),this.resetResponse(),this.mathField instanceof MathQuill&&this.mathField.revert()},setSerializedState:function(state){state&&state.response&&this.setResponse(state.response)},getSerializedState:function(){return{response:this.getResponse()}}},qtiCustomInteractionContext.register(mathEntryInteraction)}),define(["mathEntryInteraction/runtime/mathEntryInteraction"],function(PCI){return PCI});
