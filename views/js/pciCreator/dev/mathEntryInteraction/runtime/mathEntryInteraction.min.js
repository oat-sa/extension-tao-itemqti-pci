...
gte:toBoolean(config.tool_gte,!0),times:toBoolean(config.tool_times,!0),divide:toBoolean(config.tool_divide,!0),plusminus:toBoolean(config.tool_plusminus,!0)},allowNewLine:toBoolean(config.allowNewLine,!1),enableAutoWrap:toBoolean(config.enableAutoWrap,!1)}},getMqConfig:function(){var self=this;return{spaceBehavesLikeTab:!this.config.authorizeWhiteSpace,handlers:{edit:function(mathField){self.trigger("responseChange",[mathField.latex()]),self.autoWrapContent()},enter:function(mathField){(function(){return self.config.allowNewLine&&(!self.inGapMode()&&!self.inQtiCreator()||self.inGapMode()&&self.inQtiCreator())})()&&mathField.write("\\embed{br}")}}}},
