...
(stack1||0===stack1)&&(buffer+=stack1),buffer+='/>\n        <span class="icon-checkbox"></span>\n        ( ) parentheses/round brackets\n    </label>\n</div>\n<div>\n    <label class="panel">\n        <input name="curlybkts" type="checkbox" ',stack1=helpers.if.call(depth0,depth0&&depth0.curlybkts,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),
(stack1||0===stack1)&&(buffer+=stack1),buffer+='/>\n        <span class="icon-checkbox"></span>\n        { } braces/curly brackets    </label>\n</div>\n<div>\n    <label class="panel">\n        <input name="squarebkts" type="checkbox" ',stack1=helpers.if.call(depth0,depth0&&depth0.squarebkts,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),
(stack1||0===stack1)&&(buffer+=stack1),buffer+='/>\n        <span class="icon-checkbox"></span>\n        [ ] square brackets\n    </label>\n</div>\n<div>\n    <label class="panel">\n        <input name="tool_angle" type="checkbox" ',stack1=helpers.if.call(depth0,depth0&&depth0.tool_angle,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),
...
tool_minus:toBoolean(interaction.prop('tool_minus'),!0),tool_plus:toBoolean(interaction.prop('tool_plus'),!0),tool_equal:toBoolean(interaction.prop('tool_equal'),!0),tool_lower:toBoolean(interaction.prop('tool_lower'),!0),tool_greater:toBoolean(interaction.prop('tool_greater'),!0),tool_subscript:toBoolean(interaction.prop('tool_subscript'),!0),tool_integral:toBoolean(interaction.prop('tool_integral'),!0),tool_timesdot:toBoolean(interaction.prop('tool_timesdot'),!0),allowNewLine:toBoolean(interaction.prop("allowNewLine"),!1),enableAutoWrap:toBoolean(interaction.prop("enableAutoWrap"),!1)}))
,formElement.initWidget($form),formElement.setChangeCallbacks($form,interaction,{identifier:function(i,value){response.id(value),interaction.attr("responseIdentifier",value)},useGapExpression:function(i,value){toBoolean(value,!1)?(self.createAddGapBtn(),$gapStyleBox.show(),response.attr("cardinality","multiple")):(i.prop("gapExpression",""),self.removeAddGapBtn(),$gapStyleBox.hide(),response.attr("cardinality","single")),configChangeCallBack(i,value,"useGapExpression")},gapStyle:function(i,newStyle){i.prop("gapStyle",newStyle),configChangeCallBack(i,newStyle,"gapStyle")},authorizeWhiteSpace:configChangeCallBack,tool_frac:configChangeCallBack,
tool_sqrt:configChangeCallBack,tool_exp:configChangeCallBack,tool_log:configChangeCallBack,tool_ln:configChangeCallBack,tool_e:configChangeCallBack,tool_infinity:configChangeCallBack,tool_pi:configChangeCallBack,tool_cos:configChangeCallBack,tool_sin:configChangeCallBack,tool_lte:configChangeCallBack,tool_gte:configChangeCallBack,tool_times:configChangeCallBack,tool_divide:configChangeCallBack,tool_plusminus:configChangeCallBack,tool_angle:configChangeCallBack,tool_minus:configChangeCallBack,tool_plus:configChangeCallBack,tool_equal:configChangeCallBack,tool_lower:configChangeCallBack,tool_greater:configChangeCallBack,tool_subscript:configChangeCallBack,
tool_integral:configChangeCallBack,tool_timesdot:configChangeCallBack,squarebkts:function(i,value){i.prop("tool_lbrack",value),i.prop("tool_rbrack",value),i.triggerPci("configChange",[i.getProperties()])},roundbkts:function(i,value){i.prop("tool_lparen",value),i.prop("tool_rparen",value),i.triggerPci("configChange",[i.getProperties()])},curlybkts:function(i,value){i.prop("tool_lbrace",value),i.prop("tool_rbrace",value),i.triggerPci("configChange",[i.getProperties()])},allowNewLine:configChangeCallBack,enableAutoWrap:configChangeCallBack}),$gapStyleBox=$form.find(".mathgap-style-box"),
$gapStyleSelector=$gapStyleBox.find("[data-mathgap-style]"),$gapStyleSelector.select2({width:"100%",minimumResultsForSearch:1/0
}).val(interaction.prop("gapStyle")).trigger("change")},MathEntryInteractionStateQuestion.prototype.addMathFieldListener=function(){var _widget=this.widget,interaction=_widget.element;interaction.onPci("responseChange",function(latex){toBoolean(interaction.prop("useGapExpression"),!1)?interaction.prop("gapExpression",latex):interaction.prop("gapExpression","")})},MathEntryInteractionStateQuestion.prototype.createAddGapBtn=function(){var _widget=this.widget,$container=_widget.$container,$toolbar=$container.find(".toolbar"),interaction=_widget.element;$toolbar.length&&($toolbar.after($addGapBtn),$addGapBtn.on("click",function(){interaction.triggerPci("addGap")
}))},MathEntryInteractionStateQuestion.prototype.removeAddGapBtn=function(){$addGapBtn.off("click"),$addGapBtn.remove()},MathEntryInteractionStateQuestion}),define("mathEntryInteraction/creator/widget/states/states",["taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/interactions/customInteraction/states/states","mathEntryInteraction/creator/widget/states/Question"],function(factory,states){"use strict";return factory.createBundle(states,arguments,["answer","correct","map"])}),
...
tool_ln:"true",tool_e:"true",tool_infinity:"true",tool_lbrack:"true",tool_rbrack:"true",tool_pi:"true",tool_cos:"true",tool_sin:"true",tool_lte:"true",tool_gte:"true",tool_times:"true",tool_divide:"true",tool_plusminus:"true",tool_angle:'true',tool_minus:'true',tool_plus:'true',tool_equal:'true',tool_lower:'true',tool_greater:'true',tool_subscript:'true',tool_lbrace:'true',tool_rbrace:'true',tool_lparen:'true',tool_rparen:'true',tool_integral:'true',tool_timesdot:'true',allowNewLine:"false",enableAutoWrap:"false"}},afterCreate:function(pci){},getMarkupTemplate:function(){return markupTpl},
getMarkupData:function(pci,defaultData){return defaultData.prompt=pci.data("prompt"),defaultData}}}),define(["mathEntryInteraction/pciCreator"],function(PCI){return PCI});
