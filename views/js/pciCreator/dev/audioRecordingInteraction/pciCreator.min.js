...
maxRecordingTime:interaction.prop("maxRecordingTime"),isCompressed:typeCaster.strToBool(interaction.prop("isCompressed"),!0),audioBitrate:interaction.prop("audioBitrate"),isStereo:typeCaster.strToBool(interaction.prop("isStereo"),!1),useMediaStimulus:typeCaster.strToBool(interaction.prop("useMediaStimulus"),!1),displayDownloadLink:typeCaster.strToBool(interaction.prop("displayDownloadLink"),!1)})),$mediaStimulusForm=$form.find(".media-stimulus-properties-form"),$mediaStimulusForm.append(pciMediaManager.getForm()),$compressedOptions=$form.find('[data-role="compressedOptions"]'),$uncompressedOptions=$form.find('[data-role="uncompressedOptions"]'),
...
buffer+=' </div>\n    <div class="audio-rec">\n        <div class="media-stimulus"> </div>\n        <div class="input-meter">\n            <div class="leds"> </div>\n            <div class="mic"> </div>\n        </div>\n        <div class="progress"> </div>\n        <div class="controls"> </div>\n    </div>\n</div>'})}),define("audioRecordingInteraction/pciCreator",["lodash","taoQtiItem/qtiCreator/editor/customInteractionRegistry","audioRecordingInteraction/creator/widget/Widget","tpl!audioRecordingInteraction/creator/tpl/markup"],function(_,ciRegistry,Widget,markupTpl){"use strict";return{getTypeIdentifier:function(){return"audioRecordingInteraction"},
getWidget:function(){return Widget},getDefaultProperties:function(){return{allowPlayback:!0,autoStart:!1,maxRecords:2,maxRecordingTime:120,isCompressed:!0,audioBitrate:2e4,isStereo:!1,useMediaStimulus:!1,media:{autostart:!0,replayTimeout:5,maxPlays:2},displayDownloadLink:!1,updateResponsePartially:!1}},afterCreate:function(){},getMarkupTemplate:function(){return markupTpl},getMarkupData:function(pci,defaultData){return defaultData.prompt=pci.data("prompt"),defaultData}}}),define(["audioRecordingInteraction/pciCreator"],function(PCI){return PCI});
