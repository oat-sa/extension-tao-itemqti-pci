...
;simpleEditor.destroy($container),containerEditor.destroy($prompt)});return AudioRecordingInteractionStateQuestion.prototype.initForm=function(){var $mediaStimulusForm,$compressedOptions,$uncompressedOptions,$delayOptions,_widget=this.widget,$form=_widget.$form,interaction=_widget.element,response=interaction.getResponseDeclaration(),pciMediaManager=pciMediaManagerFactory(_widget);$form.html(formTpl({serial:response.serial,identifier:interaction.attr("responseIdentifier"),allowPlayback:typeCaster.strToBool(interaction.prop("allowPlayback"),!0),autoStart:typeCaster.strToBool(interaction.prop("autoStart"),!1),
