...
buffer+='>\n    <div class="panel">\n        <label for="partial-update-interval" class="spinner">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Partial update interval:",options):helperMissing.call(depth0,"__","Partial update interval:",options)))+'</label>\n        <input id="partial-update-interval" name="partialUpdateInterval" value="',(helper=helpers.partialUpdateInterval)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.partialUpdateInterval,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),
buffer+=escapeExpression(stack1)+'" class="large" data-increment="10" data-min="100" data-max="5000" type="text" />\n        <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\n        <span class="tooltip-content">\n            '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
helper?helper.call(depth0,"In milliseconds. The time interval between partial updates of the recording.",options):helperMissing.call(depth0,"__","In milliseconds. The time interval between partial updates of the recording.",options)))+'\n        </span>\n    </div>\n</div>\n\n<hr />\n\n<h3 class="txt-error"><strong><span class="icon-warning"></span> '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"For tests only",options):helperMissing.call(depth0,"__","For tests only",options)))+'</strong></h3>\n\n<div class="panel">\n    <label>\n        <input name="displayDownloadLink" type="checkbox" ',
...
$compressedOptions.show()):($uncompressedOptions.show(),$compressedOptions.hide()),configChangeCallBack(boundInteraction,value,name)},audioBitrate:configChangeCallBack,isStereo:configChangeCallBack,useMediaStimulus:function(boundInteraction,value,name){value?($mediaStimulusForm.removeClass("hidden"),$mediaStimulusForm.show(250)):$mediaStimulusForm.hide(250),configChangeCallBack(boundInteraction,value,name)},updateResponsePartially:function(boundInteraction,value,name){value?$updateResponsePartiallyOptions.show():$updateResponsePartiallyOptions.hide(),configChangeCallBack(boundInteraction,value,name)},partialUpdateInterval:configChangeCallBack,
