...
buffer+='"></div>\n</div>\n\n<hr />\n\n<div class="panel">\n    <label>\n        <input name="updateResponsePartially" type="checkbox" ',stack1=helpers.if.call(depth0,depth0&&depth0.updateResponsePartially,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+='/>\n        <span class="icon-checkbox"></span>\n        '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
helper?helper.call(depth0,"Partial update",options):helperMissing.call(depth0,"__","Partial update",options)))+'\n    </label>\n    <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\n    <span class="tooltip-content">\n        <span class="icon-warning"></span>\n        '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
helper?helper.call(depth0,"Caution, this feature may impact performance. Updates the response with the audio recording at a regular interval.",options):helperMissing.call(depth0,"__","Caution, this feature may impact performance. Updates the response with the audio recording at a regular interval.",options)))+'\n    </span>\n</div>\n\n<div data-role="updateResponsePartiallyOptions" ',stack1=helpers.unless.call(depth0,depth0&&depth0.updateResponsePartially,{hash:{},inverse:self.noop,fn:self.program(3,program3,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),
buffer+='>\n    <div class="panel">\n        <label for="partial-update-interval" class="spinner">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Update interval:",options):helperMissing.call(depth0,"__","Update interval:",options)))+'</label>\n        <input id="partial-update-interval" name="partialUpdateInterval" value="',(helper=helpers.partialUpdateInterval)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.partialUpdateInterval,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),
buffer+=escapeExpression(stack1)+'" class="large" data-increment=".1" data-min=".1" data-max="5" type="text" />\n        <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\n        <span class="tooltip-content">\n            '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
helper?helper.call(depth0,"In seconds. The time interval between partial updates of the recording.",options):helperMissing.call(depth0,"__","In seconds. The time interval between partial updates of the recording.",options)))+'\n        </span>\n    </div>\n</div>\n\n<hr />\n\n<h3 class="txt-error"><strong><span class="icon-warning"></span> '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"For tests only",options):helperMissing.call(depth0,"__","For tests only",options)))+'</strong></h3>\n\n<div class="panel">\n    <label>\n        <input name="displayDownloadLink" type="checkbox" ',
stack1=helpers.if.call(depth0,depth0&&depth0.displayDownloadLink,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+='/>\n        <span class="icon-checkbox"></span>\n        '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
...
;simpleEditor.destroy($container),containerEditor.destroy($prompt)});return AudioRecordingInteractionStateQuestion.prototype.initForm=function(){var $mediaStimulusForm,$compressedOptions,$uncompressedOptions,$updateResponsePartiallyOptions,$delayOptions,_widget=this.widget,$form=_widget.$form,interaction=_widget.element,response=interaction.getResponseDeclaration(),pciMediaManager=pciMediaManagerFactory(_widget);$form.html(formTpl(_.defaults({},module.config(),{serial:response.serial,identifier:interaction.attr("responseIdentifier"),allowPlayback:typeCaster.strToBool(interaction.prop("allowPlayback"),!0),
autoStart:typeCaster.strToBool(interaction.prop("autoStart"),!1),autoPlayback:typeCaster.strToBool(interaction.prop("autoPlayback"),!1),delayMinutes:interaction.prop("delayMinutes"),delaySeconds:interaction.prop("delaySeconds"),maxRecords:interaction.prop("maxRecords"),maxRecordingTime:interaction.prop("maxRecordingTime"),isCompressed:typeCaster.strToBool(interaction.prop("isCompressed"),!0),audioBitrate:interaction.prop("audioBitrate"),isStereo:typeCaster.strToBool(interaction.prop("isStereo"),!1),useMediaStimulus:typeCaster.strToBool(interaction.prop("useMediaStimulus"),!1),
updateResponsePartially:typeCaster.strToBool(interaction.prop("updateResponsePartially"),!1),partialUpdateInterval:parseInt(interaction.prop("partialUpdateInterval"),10)/1e3,displayDownloadLink:typeCaster.strToBool(interaction.prop("displayDownloadLink"),!1)}))),$mediaStimulusForm=$form.find(".media-stimulus-properties-form"),$mediaStimulusForm.append(pciMediaManager.getForm()),$compressedOptions=$form.find('[data-role="compressedOptions"]'),$uncompressedOptions=$form.find('[data-role="uncompressedOptions"]'),$updateResponsePartiallyOptions=$form.find('[data-role="updateResponsePartiallyOptions"]'),$delayOptions=$form.find('[data-role="delayOptions"]'),
formElement.initWidget($form),formElement.setChangeCallbacks($form,interaction,_.assign({identifier:function(i,value){response.id(value),interaction.attr("responseIdentifier",value)},allowPlayback:configChangeCallBack,autoStart:function(boundInteraction,value,name){value?$delayOptions.show():$delayOptions.hide(),configChangeCallBack(boundInteraction,value,name)},autoPlayback:configChangeCallBack,delayMinutes:configChangeCallBack,delaySeconds:configChangeCallBack,maxRecords:configChangeCallBack,maxRecordingTime:configChangeCallBack,isCompressed:function(boundInteraction,value,name){"true"===value?($uncompressedOptions.hide(),
$compressedOptions.show()):($uncompressedOptions.show(),$compressedOptions.hide()),configChangeCallBack(boundInteraction,value,name)},audioBitrate:configChangeCallBack,isStereo:configChangeCallBack,useMediaStimulus:function(boundInteraction,value,name){value?($mediaStimulusForm.removeClass("hidden"),$mediaStimulusForm.show(250)):$mediaStimulusForm.hide(250),configChangeCallBack(boundInteraction,value,name)},updateResponsePartially:function(boundInteraction,value,name){value?$updateResponsePartiallyOptions.show():$updateResponsePartiallyOptions.hide(),configChangeCallBack(boundInteraction,value,name)},
...
$interaction.length&&$interaction.addClass("tao-qti-creator-context")},AudioRecordingInteractionWidget}),define("tpl!audioRecordingInteraction/creator/tpl/markup",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="";return buffer+='<div class="audioRecordingInteraction">\n    <div class="prompt">',(helper=helpers.prompt)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.prompt,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),
...
define("audioRecordingInteraction/pciCreator",["lodash","taoQtiItem/qtiCreator/editor/customInteractionRegistry","audioRecordingInteraction/creator/widget/Widget","tpl!audioRecordingInteraction/creator/tpl/markup"],function(_,ciRegistry,Widget,markupTpl){"use strict";var audioRecordingInteractionCreator={getTypeIdentifier:function(){return"audioRecordingInteraction"},getWidget:function(){var defaultProperties;return Widget.beforeStateInit(function(event,pci){pci.typeIdentifier&&"audioRecordingInteraction"===pci.typeIdentifier&&(defaultProperties=audioRecordingInteractionCreator.getDefaultProperties(),_.forEach(defaultProperties,function(value,name){
(void 0===pci.properties[name]||"string"==typeof pci.properties[name]&&!pci.properties[name]&&"string"!=typeof value)&&(pci.properties[name]=value)}))}),Widget},getDefaultProperties:function(){return{isReviewMode:!1,allowPlayback:!0,autoStart:!1,autoPlayback:!1,delayMinutes:0,delaySeconds:0,maxRecords:2,maxRecordingTime:120,isCompressed:!0,audioBitrate:2e4,isStereo:!1,useMediaStimulus:!1,media:{autostart:!0,replayTimeout:5,maxPlays:2},displayDownloadLink:!1,updateResponsePartially:!1,partialUpdateInterval:1e3}},afterCreate:function(){},getMarkupTemplate:function(){return markupTpl},getMarkupData:function(pci,defaultData){
return defaultData.prompt=pci.data("prompt"),defaultData}};return audioRecordingInteractionCreator}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))
