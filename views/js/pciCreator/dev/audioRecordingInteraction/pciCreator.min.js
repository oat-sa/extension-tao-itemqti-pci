...
buffer+=escapeExpression(stack1)+'" class="large" data-increment="50" data-min="1000" type="text" />\n        <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\n        <span class="tooltip-content">\n            '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Lorem ipsum dolor",options):helperMissing.call(depth0,"__","Lorem ipsum dolor",options)))+'\n        </span>\n    </div>\n</div>\n\n<div data-role="uncompressedOptions"  ',stack1=helpers.if.call(depth0,depth0&&depth0.isCompressed,{hash:{},inverse:self.noop,
...
;simpleEditor.destroy($container),containerEditor.destroy($prompt)});return AudioRecordingInteractionStateQuestion.prototype.initForm=function(){var $mediaStimulusForm,$compressedOptions,$uncompressedOptions,_widget=this.widget,$form=_widget.$form,interaction=_widget.element,response=interaction.getResponseDeclaration(),pciMediaManager=pciMediaManagerFactory(_widget);$form.html(formTpl({serial:response.serial,identifier:interaction.attr("responseIdentifier"),allowPlayback:typeCaster.strToBool(interaction.prop("allowPlayback"),!0),autoStart:typeCaster.strToBool(interaction.prop("autoStart"),!1),maxRecords:interaction.prop("maxRecords"),
maxRecordingTime:interaction.prop("maxRecordingTime"),isCompressed:typeCaster.strToBool(interaction.prop("isCompressed"),!0),isLossless:typeCaster.strToBool(interaction.prop("isLossless"),!0),audioBitrate:interaction.prop("audioBitrate"),sampleRate:interaction.prop("sampleRate"),isStereo:typeCaster.strToBool(interaction.prop("isStereo"),!1),useMediaStimulus:typeCaster.strToBool(interaction.prop("useMediaStimulus"),!1),displayDownloadLink:typeCaster.strToBool(interaction.prop("displayDownloadLink"),!1),recordingFormat:interaction.prop("recordingFormat")})),$mediaStimulusForm=$form.find(".media-stimulus-properties-form"),
$mediaStimulusForm.append(pciMediaManager.getForm()),$compressedOptions=$form.find('[data-role="compressedOptions"]'),$uncompressedOptions=$form.find('[data-role="uncompressedOptions"]'),formElement.initWidget($form),formElement.setChangeCallbacks($form,interaction,_.assign({identifier:function(i,value){response.id(value),interaction.attr("responseIdentifier",value)},allowPlayback:configChangeCallBack,autoStart:configChangeCallBack,maxRecords:configChangeCallBack,maxRecordingTime:configChangeCallBack,isCompressed:function(boundInteraction,value,name){"true"===value?($uncompressedOptions.hide(),$compressedOptions.show()):($uncompressedOptions.show(),
$compressedOptions.hide()),configChangeCallBack(boundInteraction,value,name)},isLossless:configChangeCallBack,audioBitrate:configChangeCallBack,sampleRate:configChangeCallBack,isStereo:configChangeCallBack,useMediaStimulus:function(boundInteraction,value,name){value?($mediaStimulusForm.removeClass("hidden"),$mediaStimulusForm.show(250)):$mediaStimulusForm.hide(250),configChangeCallBack(boundInteraction,value,name)},displayDownloadLink:configChangeCallBack,recordingFormat:function(boundInteraction,value,name){switch(value){case"compressed_lossy":configChangeCallBack(boundInteraction,!0,"isCompressed"),configChangeCallBack(boundInteraction,!1,"isLossless"),
$uncompressedOptions.hide(),$compressedOptions.show();break;case"compressed_lossless":configChangeCallBack(boundInteraction,!0,"isCompressed"),configChangeCallBack(boundInteraction,!0,"isLossless"),$uncompressedOptions.hide(),$compressedOptions.show();break;case"uncompressed":configChangeCallBack(boundInteraction,!1,"isCompressed"),configChangeCallBack(boundInteraction,null,"isLossless"),$uncompressedOptions.show(),$compressedOptions.hide()}configChangeCallBack(boundInteraction,value,name)}},pciMediaManager.getChangeCallbacks())),pciMediaManager.init()},AudioRecordingInteractionStateQuestion}),
