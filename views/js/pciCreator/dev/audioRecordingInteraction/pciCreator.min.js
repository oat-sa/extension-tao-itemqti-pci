...
(stack1||0===stack1)&&(buffer+=stack1),buffer+='>\n    <div class="panel">\n        <label for="delayMinutes" class="spinner">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Min:",options):helperMissing.call(depth0,"__","Min:",options)))+'</label>\n        <input name="delayMinutes" value="',(helper=helpers.delayMinutes)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.delayMinutes,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),
buffer+=escapeExpression(stack1)+'" data-increment="1" data-min="0" data-max="20" type="text" />\n        <label for="delaySeconds" class="spinner">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Sec:",options):helperMissing.call(depth0,"__","Sec:",options)))+'</label>\n        <input name="delaySeconds" value="',(helper=helpers.delaySeconds)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.delaySeconds,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),
...
helper?helper.call(depth0,"Time limit:",options):helperMissing.call(depth0,"__","Time limit:",options)))+'</label>\n    <input name="maxRecordingTime" value="',(helper=helpers.maxRecordingTime)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.maxRecordingTime,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'" class="large" data-increment="10" data-min="10" data-max="',(helper=helpers.maximumRecordingTimeLimit)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.maximumRecordingTimeLimit,stack1="function"==typeof helper?helper.call(depth0,{hash:{},
data:data}):helper),buffer+=escapeExpression(stack1)+'" type="text" />\n    <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\n    <span class="tooltip-content">\n        '+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},
...
autoPlayback:typeCaster.strToBool(interaction.prop("autoPlayback"),!1),delayMinutes:interaction.prop("delayMinutes"),delaySeconds:interaction.prop("delaySeconds"),maxRecords:interaction.prop("maxRecords"),maxRecordingTime:interaction.prop("maxRecordingTime"),isCompressed:typeCaster.strToBool(interaction.prop("isCompressed"),!0),audioBitrate:interaction.prop("audioBitrate"),isStereo:typeCaster.strToBool(interaction.prop("isStereo"),!1),useMediaStimulus:typeCaster.strToBool(interaction.prop("useMediaStimulus"),!1),displayDownloadLink:typeCaster.strToBool(interaction.prop("displayDownloadLink"),!1)}))),
$mediaStimulusForm=$form.find(".media-stimulus-properties-form"),$mediaStimulusForm.append(pciMediaManager.getForm()),$compressedOptions=$form.find('[data-role="compressedOptions"]'),$uncompressedOptions=$form.find('[data-role="uncompressedOptions"]'),$delayOptions=$form.find('[data-role="delayOptions"]'),formElement.initWidget($form),formElement.setChangeCallbacks($form,interaction,_.assign({identifier:function(i,value){response.id(value),interaction.attr("responseIdentifier",value)},allowPlayback:configChangeCallBack,autoStart:function(boundInteraction,value,name){value?$delayOptions.show():$delayOptions.hide(),
configChangeCallBack(boundInteraction,value,name)},autoPlayback:configChangeCallBack,delayMinutes:configChangeCallBack,delaySeconds:configChangeCallBack,maxRecords:configChangeCallBack,maxRecordingTime:configChangeCallBack,isCompressed:function(boundInteraction,value,name){"true"===value?($uncompressedOptions.hide(),$compressedOptions.show()):($uncompressedOptions.show(),$compressedOptions.hide()),configChangeCallBack(boundInteraction,value,name)},audioBitrate:configChangeCallBack,isStereo:configChangeCallBack,useMediaStimulus:function(boundInteraction,value,name){value?($mediaStimulusForm.removeClass("hidden"),
$mediaStimulusForm.show(250)):$mediaStimulusForm.hide(250),configChangeCallBack(boundInteraction,value,name)},displayDownloadLink:configChangeCallBack},pciMediaManager.getChangeCallbacks())),pciMediaManager.init()},AudioRecordingInteractionStateQuestion}),define("audioRecordingInteraction/creator/widget/states/states",["taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/interactions/customInteraction/states/states","audioRecordingInteraction/creator/widget/states/Question"],function(factory,states){"use strict";return factory.createBundle(states,arguments,["answer","correct","map"])}),
