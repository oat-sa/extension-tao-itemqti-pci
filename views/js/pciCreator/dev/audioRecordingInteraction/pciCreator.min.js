...
autoPlayback:typeCaster.strToBool(interaction.prop("autoPlayback"),!1),maxRecords:interaction.prop("maxRecords"),maxRecordingTime:interaction.prop("maxRecordingTime"),isCompressed:typeCaster.strToBool(interaction.prop("isCompressed"),!0),audioBitrate:interaction.prop("audioBitrate"),isStereo:typeCaster.strToBool(interaction.prop("isStereo"),!1),useMediaStimulus:typeCaster.strToBool(interaction.prop("useMediaStimulus"),!1),displayDownloadLink:typeCaster.strToBool(interaction.prop("displayDownloadLink"),!1)})),$mediaStimulusForm=$form.find(".media-stimulus-properties-form"),$mediaStimulusForm.append(pciMediaManager.getForm()),
$compressedOptions=$form.find('[data-role="compressedOptions"]'),$uncompressedOptions=$form.find('[data-role="uncompressedOptions"]'),formElement.initWidget($form),formElement.setChangeCallbacks($form,interaction,_.assign({identifier:function(i,value){response.id(value),interaction.attr("responseIdentifier",value)},allowPlayback:configChangeCallBack,autoStart:configChangeCallBack,autoPlayback:configChangeCallBack,maxRecords:configChangeCallBack,maxRecordingTime:configChangeCallBack,isCompressed:function(boundInteraction,value,name){"true"===value?($uncompressedOptions.hide(),$compressedOptions.show()):($uncompressedOptions.show(),$compressedOptions.hide()),
configChangeCallBack(boundInteraction,value,name)},audioBitrate:configChangeCallBack,isStereo:configChangeCallBack,useMediaStimulus:function(boundInteraction,value,name){value?($mediaStimulusForm.removeClass("hidden"),$mediaStimulusForm.show(250)):$mediaStimulusForm.hide(250),configChangeCallBack(boundInteraction,value,name)},displayDownloadLink:configChangeCallBack},pciMediaManager.getChangeCallbacks())),pciMediaManager.init()},AudioRecordingInteractionStateQuestion}),
define("audioRecordingInteraction/creator/widget/states/states",["taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/interactions/customInteraction/states/states","audioRecordingInteraction/creator/widget/states/Question"],function(factory,states){"use strict";return factory.createBundle(states,arguments,["answer","correct","map"])}),define("audioRecordingInteraction/creator/widget/Widget",["taoQtiItem/qtiCreator/widgets/interactions/customInteraction/Widget","audioRecordingInteraction/creator/widget/states/states"],function(Widget,states){"use strict";var AudioRecordingInteractionWidget=Widget.clone()
;return AudioRecordingInteractionWidget.initCreator=function(){var $interaction;this.registerStates(states),Widget.initCreator.call(this),$interaction=this.$container.find(".audioRecordingInteraction"),$interaction.length&&$interaction.addClass("tao-qti-creator-context")},AudioRecordingInteractionWidget}),define("tpl!audioRecordingInteraction/creator/tpl/markup",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer=""
;return buffer+='<div class="audioRecordingInteraction">\n    <div class="prompt">',(helper=helpers.prompt)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.prompt,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),(stack1||0===stack1)&&(buffer+=stack1),buffer+=' </div>\n    <div class="audio-rec">\n        <div class="media-stimulus"> </div>\n        <div class="input-meter">\n            <div class="leds"> </div>\n            <div class="mic"> </div>\n        </div>\n        <div class="progress"> </div>\n        <div class="controls"> </div>\n    </div>\n</div>'})}),
define("audioRecordingInteraction/pciCreator",["lodash","taoQtiItem/qtiCreator/editor/customInteractionRegistry","audioRecordingInteraction/creator/widget/Widget","tpl!audioRecordingInteraction/creator/tpl/markup"],function(_,ciRegistry,Widget,markupTpl){"use strict";return{getTypeIdentifier:function(){return"audioRecordingInteraction"},getWidget:function(){return Widget},getDefaultProperties:function(){return{allowPlayback:!0,autoStart:!1,autoPlayback:!1,maxRecords:2,maxRecordingTime:120,isCompressed:!0,audioBitrate:2e4,isStereo:!1,useMediaStimulus:!1,media:{autostart:!0,replayTimeout:5,maxPlays:2},displayDownloadLink:!1,updateResponsePartially:!1}},
afterCreate:function(){},getMarkupTemplate:function(){return markupTpl},getMarkupData:function(pci,defaultData){return defaultData.prompt=pci.data("prompt"),defaultData}}}),define(["audioRecordingInteraction/pciCreator"],function(PCI){return PCI});
