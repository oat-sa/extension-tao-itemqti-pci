...
function MediaStreamRecorder(mediaStream) {
    ...
    this.start = function(timeSlice) {
        ...
        if (typeof MediaRecorder !== 'undefined') {
            console.log('TAO USING MEDIARECORDER');
            Recorder = MediaRecorderWrapper;
        } else if (IsChrome || IsOpera || IsEdge) {
            if (this.mimeType.indexOf('video') !== -1) {
                console.log('TAO USING WHAMMY RECORDER');
                Recorder = WhammyRecorder;
            } else if (this.mimeType.indexOf('audio') !== -1) {
                console.log('TAO USING STEREO AUDIO RECORDER');
        ...
        if (this.mimeType === 'image/gif') {
            console.log('TAO USING GIF RECORDER');
        ...
        if (this.mimeType === 'audio/wav' || this.mimeType === 'audio/pcm') {
            console.log('TAO USING STEREO AUDIO RECORDER 2');
            Recorder = StereoAudioRecorder;
        }

        // allows forcing StereoAudioRecorder.js on Edge/Firefox
        if (this.recorderType) {
            console.log('TAO USING CUSTOM RECORDER');
...
if (typeof define === 'function' && define.amd) {
    define(['audioRecordingInteraction/runtime/js/MediaStreamRecorder'], function() {
