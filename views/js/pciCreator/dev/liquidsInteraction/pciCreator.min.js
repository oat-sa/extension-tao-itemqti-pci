...
define("liquidsInteraction/creator/widget/states/Answer",["taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/interactions/states/Answer","taoQtiItem/qtiCreator/widgets/interactions/helpers/answerState"],function(stateFactory,Answer,answerStateHelper){var LiquidsInteractionStateAnswer=stateFactory.extend(Answer,function(){answerStateHelper.forward(this.widget)},function(){});return LiquidsInteractionStateAnswer.prototype.initResponseForm=function(){answerStateHelper.initResponseForm(this.widget,{rpTemplates:["CUSTOM","MATCH_CORRECT","NONE"]})},LiquidsInteractionStateAnswer}),
define("liquidsInteraction/creator/widget/states/Correct",["taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/states/Correct","lodash"],function(stateFactory,Correct,_){return stateFactory.create(Correct,function(){var widget=this.widget,interaction=widget.element,responseDeclaration=interaction.getResponseDeclaration(),correct=_.values(responseDeclaration.getCorrect());void 0!==correct[0]&&interaction.setResponse({base:{integer:correct[0]}}),interaction.onPci("responsechange.question",function(response){var correctResponse=[];null!==response.base&&correctResponse.push(response.base.integer),
responseDeclaration.setCorrect(correctResponse)})},function(){var widget=this.widget,interaction=widget.element;interaction.resetResponse(),interaction.offPci(".question")})}),define("liquidsInteraction/creator/widget/states/states",["taoQtiItem/qtiCreator/widgets/states/factory","taoQtiItem/qtiCreator/widgets/interactions/customInteraction/states/states","liquidsInteraction/creator/widget/states/Question","liquidsInteraction/creator/widget/states/Answer","liquidsInteraction/creator/widget/states/Correct"],function(factory,states){return factory.createBundle(states,arguments,["map"])}),
define("liquidsInteraction/creator/widget/Widget",["taoQtiItem/qtiCreator/widgets/interactions/customInteraction/Widget","liquidsInteraction/creator/widget/states/states"],function(Widget,states){var LiquidsInteractionWidget=Widget.clone();return LiquidsInteractionWidget.initCreator=function(){this.registerStates(states),Widget.initCreator.call(this)},LiquidsInteractionWidget}),define("tpl!liquidsInteraction/creator/tpl/markup",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{}
;var stack1,helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<div class="liquidsInteraction">\n    <div class="prompt">',(helper=helpers.prompt)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.prompt,stack1="function"==typeof helper?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'</div>\n    <canvas class="liquids" width="400" height="400"></canvas>\n</div>'})}),define("liquidsInteraction/pciCreator",["lodash","liquidsInteraction/creator/widget/Widget","tpl!liquidsInteraction/creator/tpl/markup"],function(_,Widget,markupTpl){return{getTypeIdentifier:function(){
return"liquidsInteraction"},getWidget:function(){return Widget},getDefaultProperties:function(pci){return{}},afterCreate:function(pci){},getMarkupTemplate:function(){return markupTpl},getMarkupData:function(pci,defaultData){return defaultData.prompt=pci.data("prompt"),defaultData}}}),define(["liquidsInteraction/pciCreator"],function(PCI){return PCI});
