...
define([
    ...
    function renderLabels(id, $container, config, assetManager){
        ...
        $labelMin.append($('<img>', {src: assetManager.resolve('likerNavigateLock/runtime/assets/ThumbDown.png'), 'class' : 'likert-image-append'}));
        $labelMax.prepend($('<img>', {src: assetManager.resolve('likerNavigateLock/runtime/assets/ThumbUp.png'), 'class' : 'likert-image-prepend'}));
