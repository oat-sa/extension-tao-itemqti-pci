...
define([ "qtiCustomInteractionContext" ], function (ctx) {
    ...
    var self = {
        ...
        typeIdentifier: "hmhcoPciShading",
        ...
        /** @access protected */
        // Render the portableCustomInteraction
        render: function () {
            ...
            var data = {
                gridWidth: Math.max(numRows * d, d),
                gridHeight: Math.max(numCols * d, d)
            };
        ...
        initializeGrid: function() {
            ...
            var initialSelection = selected.split(",");
            var grid = [];
